...
import { MDBContainer,MDBIcon,MDBCardImage,MDBCardGroup,MDBCard,MDBCardBody,
	MDBCardTitle,MDBCardText,MDBCardFooter } from 'mdbreact';
...
const Home = () => {
  ...
  const { filterSensors, sensorsData, getSensors, getSensorsData } = sensorContext;
	// ---------------------
    ...
    <main size="sm" style={{ marginTop: '2rem' }}>
			...
			</MDBContainer>
			{
				...
				<MDBContainer>
					...
					{ selection === 'ENV_RH' && <ENVSysModule type='1'/> }
